...
var dialogs = [
	[
		3,
		0,
		["GREETINGS COMMANDER", "I AM THE HAL OF THIS SHIP", "OUR MISSION TOGETHER", "IS TO RESCUE ALL PASSENGERS.", "SOME INSTRUCTIONS:", "TO MOVE HOLD DOWN 'K' KEY", "CONTROL MOTOR WITH J AND L","SHOOT WITH ASDF",  "GREEN ARROWS POINT TO PASSENGERS", "RED ARROWS TO ENEMIES", "AND BLUE ARROWS TO JUMP POINTS", "GOOD LUCK!"],
		-1
	],
	[
		2,

            ...
            case "alive":
            {
               switch (this.type)
               {
                  ...
                  case 6:
                     ...
                     {
                        // move closer
                        if (Rnd() < 0.08) this.vector = v.scaleTo(4);
                     }
                     else if (v.length() < 350)
                     {
                        // move away
                        if (Rnd() < 0.08) this.vector = v.invert().scaleTo(4);
                     }
                     else
                     {
